...
<html>
  <head>
    ...
    $followingposts = DB::query('SELECT * FROM users, mealplan, post_likes
      WHERE post_likes.post_id = mealplan.id AND post_likes.user_id=:userid AND mealplan.user_id = users.id;', array(':userid'=>$userid)); //WHERE mealplan.user_id = followers.user_id
  ...
  <body>
    <div id="bar">
      <ul id="nav">
        ...
        <li id= "feed"><h1>My Favourites</h1></li>
    ...
    <div id = "content">
        ...
        foreach ($followingposts as $post) {
                ...
                if (DB::query('SELECT id FROM mealplan WHERE user_id=:userid AND user_id=:user_id', array(':userid'=>$post['user_id'], ':user_id'=>$userid))) {
                    ...
                    <form action='fav.php?postid=".$post['id']."' method='post'>
            ...
            <?php
                ...
                echo "<div id = 'commentbox'><form action='fav.php?postid=".$post['id']."' method='post'>
