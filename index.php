...
<html>
  <head>
    ...
    $followingposts = DB::query('SELECT * FROM users, mealplan
      WHERE users.id = mealplan.user_id
      ORDER BY mealplan.posted_at DESC;'); //WHERE mealplan.user_id = followers.user_id
      ...
      <input type="submit" id="searchbtn" name="search" value="Search">
        ...
        foreach ($followingposts as $post) {
            ...
            <?php
                ...
                echo "<div id = 'commentbox'><form action='index.php?postid=".$post['id']."' method='post'>
